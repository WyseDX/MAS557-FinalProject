...
Model training was done on a P100 GPU using double precision. This code can normally be run on Google Colab (Tested on A1000 settings), after installing jaxopt by executing the following:
